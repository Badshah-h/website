...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      colors: {
        brand: {
          900: '#092031', // Primary Dark Navy
          700: '#074C81', // Deep Blue  
          500: '#1976d2', // Primary Blue
          300: '#4A90E2', // Light Blue derived
        },
        accent: '#ff8400', // Professional Orange
      ...
      keyframes: {
        ...
        pulseGlow: {
          '0%': { boxShadow: '0 0 20px rgba(255, 132, 0, 0.3)' },
          '100%': { boxShadow: '0 0 30px rgba(255, 132, 0, 0.6)' },
        },
        'accordion-down': {
          from: { height: '0' },
      ...
      backgroundImage: {
        ...
        'brand-gradient': 'linear-gradient(135deg, #092031 0%, #1976d2 100%)',
      },
      backdropBlur: {
        xs: '2px',
      },
